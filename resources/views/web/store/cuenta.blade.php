...
@section('content')
    ...
    <div class="card card-purple">
        ...
        --}}<div class="card-body">
            ...
            {!! Form::open(['route' => ['wordpress.cuenta.update'], 'method' => 'post']) !!}
            ...
            <div class="form-group text-right">
                ...
                <button type="submit" class="btn btn-block btn-success" onclick="verCargando();"><span class="text-bold" style="color: white;">{{ $boton }}</span></button>
            </div>
