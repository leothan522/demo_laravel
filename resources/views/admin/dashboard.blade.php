...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                <span class="info-box-icon bg-warning elevation-1"><a href="{{ route('pedidos.index') }}"><i class="fas fa-shopping-bag"></i></a></span>

                <div class="info-box-content">
                    <span class="info-box-text">Pedidos</span>
                    <span class="info-box-number">{{ formatoMillares($pedidos_total, 0) }}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <!-- TABLE: LATEST ORDERS -->
            <div class="card">
                        ...
                        <table class="table m-0">
                            ...
                            @foreach ($pedidos as $pedido)
                                <tr>
                                    ...
                                    <td>{{ strtoupper($pedido->nombre) }} {{ strtoupper($pedido->apellidos) }}</td>
                                    <td><span class="badge badge-info">{{ estatusPedido($pedido->estatus) }}</span></td>
                                    <td><i class="fa fa-dollar-sign"></i> {{ formatoMillares($pedido->total) }}</td>
                                    {{--<td>
                ...
                <div class="card-footer clearfix">
                    <a href="{{ route('pedidos.ver', 1) }}" class="btn btn-sm btn-info float-left">Pedidos en Espera</a>
                    <a href="{{ route('pedidos.index') }}" class="btn btn-sm btn-secondary float-right">Ver Todos los Pedidos</a>
                </div>
                <!-- /.card-footer -->
            </div>
            <!-- /.card -->
    ...
    <div class="col-md-4">
        ...
        <div class="info-box mb-3 bg-warning">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{ formatoMillares($en_espera, 0) }}</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
